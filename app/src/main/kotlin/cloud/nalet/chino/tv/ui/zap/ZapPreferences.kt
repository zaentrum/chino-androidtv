...
/**
 * In-memory preference vector — faithful port of chino-web's useZapPreferences.
 * Three weight tables (genre / cast / type) with decay-first updates and a
 * tanh-squashed score. Session-scoped: the vector dies with the screen (V2
 * persists it to Postgres). Not thread-safe — drive from the ViewModel scope.
 */
